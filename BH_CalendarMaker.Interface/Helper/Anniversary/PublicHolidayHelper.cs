...
namespace BH_CalendarMaker.Interface.Helper.Anniversary
{
    ...
    public class PublicHolidayHelper
    {
        ...
        #region 생성자 - PublicHolidayHelper(serviceKey)

        /// <summary>
        /// 생성자
        /// </summary>
        /// <param name="serviceKey">서비스 키</param>
        public PublicHolidayHelper(string serviceKey)
        {
            ...
            this.urlFormat = "http://apis.data.go.kr/B090041/openapi/service/SpcdeInfoService/getRestDeInfo?serviceKey={0}&solYear={1:d4}&solMonth={2:d2}";
