...
namespace BH_CalendarMaker.Interface.Helper.Anniversary
{
    ...
    /// 국경일 헬퍼
    /// </summary>
    public class NationalHolidayHelper
    {
        //////////////////////////////////////////////////////////////////////////////////////////////////// Field
        ////////////////////////////////////////////////////////////////////////////////////////// Private
        ...
        #region 생성자 - NationalHolidayHelper(serviceKey)

        /// <summary>
        /// 생성자
        /// </summary>
        /// <param name="serviceKey">서비스 키</param>
        public NationalHolidayHelper(string serviceKey)
        {
            ...
            this.urlFormat = "http://apis.data.go.kr/B090041/openapi/service/SpcdeInfoService/getHoliDeInfo?serviceKey={0}&solYear={1:d4}&solMonth={2:d2}";
