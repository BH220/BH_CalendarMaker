...
namespace BH_CalendarMaker.Interface.Helper.Anniversary
{
    ...
    /// 24 절기 헬퍼
    /// </summary>
    public class SeasonalEtcDivisionHelper
    {
        //////////////////////////////////////////////////////////////////////////////////////////////////// Field
        ////////////////////////////////////////////////////////////////////////////////////////// Private
        ...
        #region 생성자 - SeasonalEtcDivisionHelper(serviceKey)

        /// <summary>
        /// 생성자
        /// </summary>
        /// <param name="serviceKey">서비스 키</param>
        public SeasonalEtcDivisionHelper(string serviceKey)
        {
            ...
            this.urlFormat = "http://apis.data.go.kr/B090041/openapi/service/SpcdeInfoService/getSundryDayInfo?serviceKey={0}&solYear={1:d4}&solMonth={2:d2}";
        ...
        private List<DayInfo> GetDayInfoList(string html)
        {
            ...
            if (colleciton != null && colleciton.Count > 0)
            {
                ...
                foreach (HtmlNode childNode in itemsNode.ChildNodes)
                {
                    ...
                    string date = childNode.ChildNodes[3].InnerText;
                    string sequence = childNode.ChildNodes[4].InnerText;
